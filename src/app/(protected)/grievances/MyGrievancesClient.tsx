        ...
        <Card className="border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900">
          <CardContent className="p-4 flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
              <div className="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-slate-800 rounded-md shrink-0 w-full sm:w-auto justify-center">
              ...
              <div className="flex flex-1 gap-3">
                <Select value={statusFilter} onValueChange={(val) => { if (val) setStatusFilter(val) }}>
                  <SelectTrigger className="flex-1 min-w-[120px] bg-white dark:bg-slate-950 border-slate-300 text-sm">
